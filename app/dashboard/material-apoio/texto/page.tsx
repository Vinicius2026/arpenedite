  ...
  return (
    <header className="border-b border-white/10 bg-black/60 backdrop-blur-2xl sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center gap-4">
        <button
          onClick={onBack}
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 transition-all group focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60"
        >
        ...
        <div className="flex items-center gap-4">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-500/90 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
            <FileText className="w-5 h-5 text-white" />
          </div>
          <div>
            <div className="text-xs text-white/40 uppercase tracking-[0.2em]">Material de Apoio</div>
            <h1 className="text-2xl font-semibold tracking-tight text-white">Material de Texto</h1>
            <p className="text-sm text-white/50">Documentos e materiais escritos</p>
          </div>
        </div>
      </div>
    </header>
  ...
  return (
    <div className="mb-8 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl px-6 py-4 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-xl bg-blue-500/15 border border-blue-500/20 text-blue-400">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
        <div className="relative">
          ...
          <input
            ...
            className="w-full sm:w-64 pl-9 pr-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm text-white placeholder:text-white/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50"
          />
        </div>
        <div className="relative">
          ...
          <select
            ...
            className="w-full sm:w-44 pl-9 pr-8 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50"
          >
  ...
  return (
    ...
    >
      <div className="col-span-12 md:col-span-6 flex items-center gap-3">
        <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform">
          <FileText className="w-5 h-5 text-white" />
        </div>
        <div className="min-w-0 flex-1">
          <a
            ...
            className="font-semibold text-white text-sm truncate hover:text-blue-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 rounded"
      ...
      <div className="col-span-12 md:col-span-2 flex items-center justify-start md:justify-end">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600/90 hover:bg-blue-600 text-white text-sm font-medium transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60"
